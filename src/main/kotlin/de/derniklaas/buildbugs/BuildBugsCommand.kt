...
object BuildBugsCommand {
    fun register(dispatcher: CommandDispatcher<FabricClientCommandSource>, registryAccess: CommandRegistryAccess) {
        dispatcher.register(literal<FabricClientCommandSource>("buildbug").then(literal<FabricClientCommandSource>("config").then(
        ...
        ).then(literal<FabricClientCommandSource?>("eventip").then(argument(
